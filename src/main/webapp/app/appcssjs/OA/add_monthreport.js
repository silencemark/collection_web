...
$(function(){
	...
	var opt={};
		...
		opt.datetime = {preset : 'date', dateFormat: 'yy-mm' }; 
	...
	$("#monthtime").scroller('destroy').scroller($.extend(opt['datetime'], opt['default']));
});
...
function addMonthReport(){
	...
	$.ajax({
		url:projectpath+"/app/addMonthly",
		type:"post",
