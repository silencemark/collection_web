var fangwen_url = "/app/getNoExaminePunishListInfo";
var userid = "";
	...
	if(list.length > 0 && list != null){
		...
		$.each(list,function(i,map){
			...
			if(map.examineuserid == userid){
				onclick_url = 'punish_check.html?punishid='+map.punishid+"&userid="+userid+'&forwarduserid='+map.id;
			}
			htm += '<li onclick="intoDetail(\''+onclick_url+'\',\''+map.punishid+'\',\''+map.isread+'\',8)">'+
