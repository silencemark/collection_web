var fangwen_url = "/app/getBeforeMealList";
var userid = "";
var obj = new Object();
...
function showData(list){
	if(list.length > 0 && list != null){
		...
		$.each(list,function(i,map){
			...
			htm += '<li onclick="intoDetail(\''+onclick_url+'\',\''+map.inspectid+'\',\''+map.isread+'\',11)">'+
			        	'<div class="xx_01"><span '+isread+'><span class="name">'+map.createname+'的餐前检查</span></span><em class="red">待处理</em></div>'+
