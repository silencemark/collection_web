var fangwen_url = "/app/getReadedRewardListInfo";
var userid = "";
...
function showData(list){
	if(list.length > 0 && list != null){
		...
		$.each(list,function(k,item){
			var rewardlist = item.rewardlist;
			...
			$.each(rewardlist,function(i,map){
				var isread = '';
				//判断是否阅读
				...
				var htm = '<li class="li_del" onclick="intoDetail(\''+onclick_url+'\',\''+map.rewardid+'\',\''+map.isread+'\',9)">'+
			...
			//添加数据条数
			$('#'+createdate+'_i').text(rewardlist.length);
