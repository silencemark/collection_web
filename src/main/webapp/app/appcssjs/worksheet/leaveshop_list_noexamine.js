var fangwen_url = "/app/getLeaveShopList";
var userid = "";
var obj = new Object();
...
function showData(list){
	if(list.length > 0 && list != null){
		...
		$.each(list,function(i,map){
			...
			htm += '<li onclick="intoDetail(\''+onclick_url+'\',\''+map.inspectid+'\',\''+map.isread+'\',10)">'+
			        	'<div class="xx_01"><span '+isread+'><span class="name">'+map.createname+'的离店报告</span></span><em class="red">待处理</em></div>'+
