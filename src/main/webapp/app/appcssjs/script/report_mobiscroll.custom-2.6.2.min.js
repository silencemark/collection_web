...
p.mode?'<div class="dwb-e dwwb dwwbp" style="height:'+H+"px;line-height:"+H+'px;"><span>+</span></div><div class="dwb-e dwwb dwwbm" style="height:'+H+"px;line-height:"+H+'px;"><span>&ndash;</span></div>':"")+'<div class="dwl">'+b+'</div><div tabindex="0" aria-live="off" aria-label="'+b+'" role="listbox" class="dwww"><div class="dww" style="height:'+p.rows*H+"px;min-width:"+p.width+'px;"><div class="dw-ul">';h+=y(g);
if(h.indexOf("<table cellpadding=\"0\" cellspacing=\"0\">")==h.lastIndexOf("<table cellpadding=\"0\" cellspacing=\"0\">")){
	if(h.indexOf("</div><div class=\"dwwol\"></div></div><div class=\"dwwo\"></div></div><div class=\"dwwol\" name=\"tableone\" style=\"width:106%; left:0px;\"></div></div></td>")==h.lastIndexOf("</div><div class=\"dwwol\"></div></div><div class=\"dwwo\"></div></div><div class=\"dwwol\" name=\"tableone\" style=\"width:106%; left:0px;\"></div></div></td>")){
		h+='</div><div class="dwwol"></div></div><div class="dwwo"></div></div><div class="dwwol" name=\"tableone\" style="width:106%; left:0px;"></div></div></td>';
	}else{
		h+='</div><div class="dwwol"></div></div><div class="dwwo"></div></div><div class="dwwol" name=\"tableone\"></div></div></td>';	
	}
}else{
	if(h.indexOf("</div><div class=\"dwwol\"></div></div><div class=\"dwwo\"></div></div><div class=\"dwwol\" name=\"tabletwo\" style=\"width:150%;\"></div></div></td>")<0){
		h+='</div><div class="dwwol"></div></div><div class="dwwo"></div></div><div class="dwwol" name=\"tabletwo\" style=\"width:150%;\"></div></div></td>';
	}else{
		h+='</div><div class="dwwol"></div></div><div class="dwwo"></div></div><div class="dwwol" name=\"tabletwo\"></div></div></td>';	
	}
}

if(a==0){
	if(h.indexOf("<td style=\"font-size:25px;display:none;\">:</td>")<0){
		h+="<td style=\"font-size:25px;display:none;\">:</td>";
	}else{
		h+="<td style=\"font-size:25px;color:#C0C0C0;\">:</td>";
	}
}
