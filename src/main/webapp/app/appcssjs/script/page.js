function PageHelper(s){
	...
	var ajaxSettings = {
			...
			before:function(){ 
				$this.s.fresh_id = "fresh_page_ajax";
				//$("body").append('<div class="load_more '+$this.s.fresh_id+'"><a>加载中...</a></div>').trigger("create");
				$this.s.beforefun($this.s);
			 ...
			 */
				...
				$this.s.afterfun($this.s);
				//$("."+$this.s.fresh_id).remove();
