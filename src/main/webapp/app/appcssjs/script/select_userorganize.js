...
function morechange_confirmexanine(){
	...
	var userparam = $('input[name=userid]');
	...
	var organizeparam = $('input[name=organizeid]');
	$.each(organizeparam,function(i,index){
		var organizelist={};
		organizelist['organizeid']=$(index).val();
		organizename_realname += $(index).attr("organizename")+"，";
