						   ...
						   if(flg){
							...
							/*var  html='<div onclick="$(\'.carrousel\').remove();" style="width:'+width+';height:'+height+';top:'+top+',left:'+left+';display:block" class="carrousel"> <span class="close entypo-cancel"></span>'; 
						     ...
						     var html = 
										...
										'<div style="position: fixed; top:'+(top+265)+'px; z-index: 9001;left:'+left+'px; height:30px; line-height:30px; width:300px; color:white;background-color:white;"><span style="margin-left:97px; color:#555;">顾客满意度二维码</span></div>'+
										'</div>';
						     $("body").append(html);
