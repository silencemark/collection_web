...
if(h.indexOf("<table cellpadding=\"0\" cellspacing=\"0\">")==h.lastIndexOf("<table cellpadding=\"0\" cellspacing=\"0\">")){
	if(h.indexOf("</div><div class=\"dwwol\"></div></div><div class=\"dwwo\"></div></div><div class=\"dwwol\" name=\"tableone\" style=\"width:106%;\"></div></div></td>")==h.lastIndexOf("</div><div class=\"dwwol\"></div></div><div class=\"dwwo\"></div></div><div class=\"dwwol\" name=\"tableone\" style=\"width:106%;\"></div></div></td>")){
		h+='</div><div class="dwwol"></div></div><div class="dwwo"></div></div><div class="dwwol" name=\"tableone\" style="width:106%;"></div></div></td>';
	}else{
