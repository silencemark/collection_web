...
(function(root, factory) {
    ...
    var defaults = {
        ...
        NEW_DAY_CLASS = 'new',
        TODAY_CLASS = 'now',
        //SELECT_CLASS = 'selected',---- xionggang 16-10-22
        SELECT_CLASS = 'now',
    ...
    Calendar.prototype = {
        ...
        render: function() {
            ...
            //this.$label = this.$element.find('.calendar-label');------xionggang 16-10-22
        ...
        event: function() {
            ...
            // hover
//            _this.$element.on('mouseenter', '[' + ITEM_DAY + ']', function(e) { ---- xionggang 16-10-22
