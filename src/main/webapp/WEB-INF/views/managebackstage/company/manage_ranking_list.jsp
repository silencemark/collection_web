...
function pageHelper(num){
	...
	$.ajax({
 		type:'post',
 		url:'/managebackstage/getRankingList',
 		data:param,
...
<jsp:include page="../left.jsp"></jsp:include>
    <div class="right_page">
    	<div class="page_nav"><p><a href="#">首页</a><i>/</i><a href="<%=request.getContextPath() %>/managebackstage/getCompanyList">企业信息列表</a><i>/</i><a href="<%=request.getContextPath() %>/managebackstage/getCompanyInfo?companyid=${map.companyid}">公司信息</a><i>/</i><span>KPI星值排行</span></p></div>
        <div class="page_tab">
            <div class="sel_box">
            	<input type="hidden" id="organizeid" value=""/>
            	 <span class="sel" style="float:left;padding-left:0px; margin-right:5px;" id="organizename">${companyInfo.companyname }</span>
                 ...
                 <input type="button" value="" class="find_btn1"  onclick="checkSearch()" />
                <div class="clear"></div>
            </div>
            <div class="tab_list">
