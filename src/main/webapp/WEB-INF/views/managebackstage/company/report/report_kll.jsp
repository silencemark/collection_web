...
<div class="main_page">
    ...
    <div class="right_page">
    	<div class="page_nav"><p><a href="#">首页</a><i>/</i><a href="<%=request.getContextPath() %>/managebackstage/getCompanyList">企业信息列表</a><i>/</i><a href="<%=request.getContextPath() %>/managebackstage/getCompanyInfo?companyid=${map.companyid}">公司信息</a><i>/</i><span>报表管理/客流量</span></p></div>
        <div class="page_tab2">        	
            ...
            <div class="mrbb_nav">
                 <ul>
                    ...
                    <li class="active"><a href="<%=request.getContextPath()%>/managebackstage/getReportFlowChart?companyid=${map.companyid}">客流量</a></li>
