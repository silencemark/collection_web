	...
	if(data != null && data.num > 0){
		...
		$.each(data.reportlist,function(i,map){
			...
			html += '<tr>'+
			            ...
			            '<td><a href="/managebackstage/getDailyreportInfo?reportid='+map.reportid+'&forwarduserid='+map.forwarduserid+'" class="link">查看</a></td>'+
	        		 '</tr>';
		});
...
<div class="main_page">
    ...
    <div class="right_page">
    	<div class="page_nav"><p><a href="#">首页</a><i>/</i><a href="<%=request.getContextPath() %>/managebackstage/getCompanyList">企业信息列表</a><i>/</i><a href="<%=request.getContextPath() %>/managebackstage/getCompanyInfo?companyid=${map.companyid}">公司信息</a><i>/</i><span>报表管理/营业额</span></p></div>
        <div class="page_tab2">        	
            ...
            <div class="mrbb_nav">
                <ul>
                    <li class="active"><a href="<%=request.getContextPath()%>/managebackstage/getReportIncomeChart?companyid=${map.companyid}">营业额</a></li>
