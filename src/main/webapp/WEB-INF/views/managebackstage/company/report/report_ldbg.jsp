...
function getdata(){
	...
	$.ajax({
		...
		url:projectpath+'/app/getReportLeaveShopInfo?organizeid='+organizeid,
...
function getLeaveShopLis(){
	...
	$.ajax({
		url:projectpath+"/app/getLeaveShopListOnlyOnePC",
		data:param,
		type:"post",
	...
	if(list != null && list.length > 0){
		...
		$.each(list,function(i,map){
			html += '<tr>'+
		                ...
		                '<td><a href="/managebackstage/getLeavedetailInfo?inspectid='+map.inspectid+'&forwarduserid='+map.forwarduserid+'" class="link">查看</a></td>'+
		            '</tr>';
		});
		$('#ldbglist').append(html);
	}
}
...
<div class="main_page">
    ...
    <div class="right_page">
    	<div class="page_nav"><p><a href="#">首页</a><i>/</i><a href="<%=request.getContextPath() %>/managebackstage/getCompanyList">企业信息列表</a><i>/</i><a href="<%=request.getContextPath() %>/managebackstage/getCompanyInfo?companyid=${map.companyid}">公司信息</a><i>/</i><span>报表管理/离店报告</span></p></div>
        <div class="page_tab2">        	
            ...
            <div class="mrbb_nav">
                ...
                <ul>
                    ...
                    <li class="active"><a href="<%=request.getContextPath()%>/managebackstage/getReportLeavePage?companyid=${map.companyid}">离店报告</a></li>
