...
<div class="left_menu">
    	<ul>
            ...
            <li><span class="bg_hidden" id="userlist"><a href="<%=request.getContextPath() %>/managebackstage/getUserList" class="bg_01">首页电影管理</a></span><div class="line"></div></li>
            <li><span class="bg_hidden" id="syscloud"><a href="<%=request.getContextPath() %>/managebackstage/getAdminUserList" class="bg_05">VIP会员卡管理</a></span><div class="line"></div></li>
