        ...
        <div class="tab_name"><span class="gray1">统计</span></div>
      	<div class="skydrive_ico">
        	<ul>
                ...
                <li><a href="<%=request.getContextPath()%>/managebackstage/getNewStatistics"><b class="bg_yellow"><img src="../userbackstage/images/page/total_ico03.png" width="32" height="32" /></b></a><span>新增统计</span></li>
