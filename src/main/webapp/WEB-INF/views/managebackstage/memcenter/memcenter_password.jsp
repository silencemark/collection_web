...
function updataPassword(){
	...
	parma.new_password =new_password;
	...
	if(num == 1){
		$.ajax({
			type:"post",
			url:"/managebackstage/updataPassword",
			data:parma,
			success:function(data){
				if(data.status==1){
					...
					location.href='/managebackstage/login';
				}
			}
		})
	}else{
        ...
        <div class="tab_list">
        	<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:12px;">
                ...
                <tr class="noneborder">
                    ...
                    <td colspan="2" ><input type="password" class="text" placeholder="请输入新密码" id="new_password"/></td>
                </tr>  
                <tr class="noneborder">
                ...
                <tr class="foot_td">
                	<td>&nbsp;</td>
                    <td colspan="2"><a href="#" class="a_btn wid_01 bg_yellow" onclick="updataPassword()">重置密码</a><a href="<%=request.getContextPath() %>/managebackstage/getSystemUser" class="a_btn bg_gay2">取消</a></td>
                </tr>
            </table>
        </div>
    </div>
