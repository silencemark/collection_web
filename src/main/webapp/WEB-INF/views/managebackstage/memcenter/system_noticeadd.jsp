	...
	function checkadd(){
		...
		if(mess != ""){
			...
			$.ajax({
				type:'post',
				dataType:'json',
				url:'<%=request.getContextPath() %>/managebackstage/insertSystemMessage',
				data:parma,
				success:function(data){
					if(data.status==1){
						...
						swal({
							...
							location.href="/managebackstage/getSystemMessage";
						});
					}
				}
			})
...
<div class="head_box">
    ...
    <div class="notice_add">
    	<div class="box">
        	<div class="name_text"><input type="text" class="text" placeholder="请输入标题,最多输入20字" maxlength="20"  id="title"/></div>
            <div class="edit_box" style="height:400px;"id="myEditor">
           
            </div>
            <div class="add_btn">
            	<a href="javascript:void(0)" class="bg_yellow" onclick="checkadd()">保存</a>
            	<a href="/managebackstage/getSystemMessage" class="bg_gay2">取消</a>
            </div>
