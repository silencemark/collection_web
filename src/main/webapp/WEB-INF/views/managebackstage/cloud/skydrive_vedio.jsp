...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#file_upload').fileupload({    
			...
			autoUpload:true,
	        dataType: 'json',
	        acceptFileTypes:  /(\.|\/)(wmv|asf|asx|rm| rmvb|mpg|mpeg|mpe|3gp|mov|mp4|m4v|avi|dat|mkv|flv|vob)$/i, 
...
<div class="main_page">
	...
	<div class="page_nav"><p><a href="#">首页</a><i>/</i><a href="<%=request.getContextPath() %>/managebackstage/intoSkyDrivePage">餐饮大师云盘</a><i>/</i><span>视频</span></p></div>        
    <div class="page_tab">
        ...
        <div class="sel_box">
            ...
            <form action="<%=request.getContextPath() %>/managebackstage/getSystemCloudVedioList" method="post" id="fuzzy_form">
...
<form action="<%=request.getContextPath()%>/managebackstage/getSystemCloudVedioList" id="child_form" method="post">
