...
function exportexcel(){
	$.ajax({
        type: "POST",
        url: "<%=request.getContextPath() %>/pc/exportUseList",
...
<div class="page_main">
    ...
    <div class="right_page">
    	<div class="page_name"><span>用料单列表</span><a href="javascript:void(0)" onclick="exportexcel();">导出</a><c:if test="${powerMap.power2001010 != null}"><a href="<%=request.getContextPath() %>/pc/initInsertMaterial">新建</a></c:if></div>
        <div class="page_tab">
            <div class="sel_box">
            	<form action="<%=request.getContextPath() %>/pc/getMaterialOrder" id="searchform">
            ...
            <div class="tab_list">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                        	<a href="<%=request.getContextPath() %>/pc/getMaterialInfo?orderid=${item.orderid}&forwarduserid=${item.forwarduserid}" class="link">查看</a>
                ...
                <c:if test="${fn:length(orderlist) == 0 }">
                	<c:if test="${powerMap.power2001010 != null}">
                		<div class="list_none"><span><i class="yellow">Hello,我是大狮！</i><br>还没有用料单，赶紧添加一条吧~</span><b><img src="<%=request.getContextPath() %>/userbackstage/images/index/none_msg.gif" width="293" height="240"></b></div>
                	</c:if>
                	<c:if test="${powerMap.power2001010 == null}">
                		<div class="list_none"><span><i class="yellow">Hi,我是大狮！</i><br>列表空空，还没有用料单呢~</span><b><img src="<%=request.getContextPath() %>/userbackstage/images/index/none_msg2.gif" width="293" height="240"></b></div>
                	</c:if>
                </c:if>
            </div>
