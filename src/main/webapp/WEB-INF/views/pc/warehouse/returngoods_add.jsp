...
<div class="page_main">
    ...
    <div class="right_page">
    	<div class="page_name"><span>新建退货单</span><a href="<%=request.getContextPath() %>/pc/getReturnOrder" class="back">返回</a></div>
            ...
            <div class="tab_list">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="none_border">
                    ...
                    <tr class="first_td">
                    	...
                    	<input type="hidden" id="examineuserid" value="">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="text" id="returntime"  readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/></td>
                    </tr>
                    <tr>
...
function submitdata(){
	...
	var orderno='${orderno}';
	var organizeid=$('select[name=organizeid]').val();
	var url='<%=request.getContextPath()%>/app/insertReturn';
	...
	param.returntime = $("#returntime").val();
		...
		success:function(data){
			if(data.status==1){
				...
				swal({
					...
					location.href="<%=request.getContextPath() %>/pc/getReturnOrder";
				});
			}
		},error:function(text){
			alert("添加失败");
