...
function exportexcel(){
	$.ajax({
        type: "POST",
        url: "<%=request.getContextPath() %>/pc/exportEmployeePunish",
...
<div class="page_main">
    ...
    <div class="right_page">
        ...
        <div class="page_tab">  
        	<form action="<%=request.getContextPath() %>/pc/getPathPunishList" method="post" id="searchform">     	
	            <div class="sel_box">
            ...
            <div class="rsgj_nav">
                <ul>
                    ...
                    <li class="active"><a href="javascript:void(0)" onclick="locationurl('<%=request.getContextPath() %>/pc/getPathPunishList');">处罚记录</a></li>
                </ul>
            </div>
            <div class="tab_list">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <c:forEach items="${datalist}" var="item">
	                    <tr>
	                        ...
	                        <td><a href="/pc/getEmployeePunishDetailInfo?punishid=${item.punishid}" class="blue">查看</a></td>
	                    </tr>
                    </c:forEach>
                 </table>
