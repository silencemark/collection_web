...
function exportexcel(){
	$.ajax({
        type: "POST",
        url: "<%=request.getContextPath() %>/pc/exportPatrollogList",
...
<div class="page_main">
    ...
    <div class="right_page">
    	<div class="page_name"><span>巡店日志</span><a href="javascript:void(0)" onclick="exportexcel();">导出</a><a href="<%=request.getContextPath() %>/pc/initInsertTourStore">新建</a></div>
        <div class="page_tab">
            <div class="sel_box">
            	<form action="<%=request.getContextPath() %>/pc/getTourStoreList" id="searchform">
            ...
            <div class="tab_list">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <c:forEach items="${datalist }" var="item">
                    	<tr>
	                        ...
	                        <td><a href="<%=request.getContextPath() %>/pc/getTourStoreInfo?tourstoreid=${item.tourstoreid}&forwarduserid=${item.forwarduserid}" class="link">查看</a>
                ...
                <c:if test="${fn:length(datalist) == 0 }">
                	<div class="list_none"><span><i class="yellow">Hi,我是大狮！</i><br>列表空空，还没有巡店日志单呢~</span><b><img src="<%=request.getContextPath() %>/userbackstage/images/index/none_msg2.gif" width="293" height="240"></b></div>
                </c:if>
            </div>
