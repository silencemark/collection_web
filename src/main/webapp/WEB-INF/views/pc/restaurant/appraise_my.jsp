...
<div class="page_main">
    ...
    <div class="right_page">
    	<div class="page_name"><span>我的关注</span><%-- <a href="<%=request.getContextPath() %>/pc/getStoreEvaluateList" class="wid_01">我的关注</a> --%></div>
        <div class="page_tab">
            <div class="sel_box">
            	<form action="<%=request.getContextPath() %>/pc/getMyStoreEvaluate" id="searchform">
            ...
            <div class="tab_list">
                    ...
                    <c:forEach items="${datalist }" var="item">
                    	...
                    	<td colspan="3" class="appraise_td">
                        	<div class="appraise">
                            	...
                            	<c:choose>
                            		<c:when test="${item.isfollow==0 }">
                            		<a href="javascript:void(0)" onclick="attention('${userInfo.userid}','${item.evaluateid}','${item.companyid}','${item.isfollow}',this)" class="green">关注</a></i>
                            		</c:when>
                            		<c:otherwise>
                            		<a href="javascript:void(0)" onclick="attention('${userInfo.userid}','${item.evaluateid}','${item.companyid}','${item.isfollow}',this)" class="red">取消关注</a></i>
                            		</c:otherwise>
                            	</c:choose>
                            	</div>
                                <div class="box">
                ...
                <c:if test="${fn:length(datalist) == 0 }">
                	<div class="list_none"><span><i class="yellow">Hello,我是大狮！</i><br>还没有关注顾客满意度信息的~</span><b><img src="<%=request.getContextPath() %>/userbackstage/images/index/none_msg2.gif" width="293" height="240"></b></div>
                </c:if>
            </div>
