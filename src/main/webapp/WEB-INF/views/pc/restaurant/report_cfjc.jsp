	...
	if(list != null && list.length > 0){
		...
		$.each(list,function(i,map){
			html += '<tr>'+
		                ...
		                '<td><a href="'+projectpath+'/pc/getKitchenInfo?inspectid='+map.inspectid+'&forwarduserid='+map.forwarduserid+'" class="link">查看</a></td>'+
		            '</tr>';
		});
        ...
        <div class="page_tab2">        	
            ...
            <div class="mrbb_nav">
                ...
                <ul>
                    ...
                    <li class="active"><a href="<%=request.getContextPath()%>/pc/getReportKitChencheckPage">厨房检查</a></li>
