...
function exportexcel(){
	$.ajax({
        type: "POST",
        url: "<%=request.getContextPath() %>/pc/exportEmployeeReward",
...
<div class="page_main">
    ...
    <div class="right_page">
        ...
        <div class="page_tab">  
        	<form action="<%=request.getContextPath() %>/pc/getPathRewardList" method="post" id="searchform">     	
	            <div class="sel_box">
            ...
            <div class="rsgj_nav">
                <ul>
                    <li><a href="javascript:void(0)" onclick="locationurl('<%=request.getContextPath() %>/pc/getPathKpiStarList');">KPI星级考核</a></li>
                    <li class="active"><a href="javascript:void(0)" onclick="locationurl('<%=request.getContextPath() %>/pc/getPathRewardList');">奖励记录</a></li>
            ...
            <div class="tab_list">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <c:forEach items="${datalist}" var="item">
	                    <tr>
	                    	<td><div class="img f"><img src="${item.headimage}" width="30" height="30" /></div><i class="i_name">${item.realname}</i></td>
	                    	<td>${item.rewardresult}</td>
	                        <td>${item.createtime}</td>
	                        <td><a href="/pc/getEmployeeRewardDetailInfo?rewardid=${item.rewardid}" class="blue">查看</a></td>
	                    </tr>
                    </c:forEach>
                 </table>
                 <c:if test="${fn:length(datalist) == 0 }">
                		<div class="list_none"><span><i class="yellow">Hi,我是大狮！</i><br>列表空空，奖励单呢~</span><b><img src="<%=request.getContextPath() %>/userbackstage/images/index/none_msg2.gif" width="293" height="240"></b></div>
                </c:if>
            </div>
