...
<div class="page_main">
    ...
    <div class="right_page">
    	<div class="page_name"><span>奖励单审核审核</span><a href="#" class="back">返回</a><a href="#">导出</a><a href="#">转发</a></div>
        <div class="page_tab2">            
            <div class="tab_list">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="none_border">
                    <tr>
                    	<td class="l_name">姓名</td>
                        <td><span id="rewardname"></span></td>
                    </tr>
                    <tr>
                    	<td class="l_name">部门</td>
                        <td><span id="rewardeptname"></span></td>
                    </tr>
                   <tr>
                    	<td class="l_name">职务</td>
                        <td><span id="rewardposition"></span></td>
                    </tr>
                    <tr>
                    	<td class="l_name">奖励结果</td>
                        <td><span id="rewardresulttext"></span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    	<td>&nbsp;</td>
                        <td><a href="#" class="a_btn bg_yellow" onclick="updateRewardInfo()">同意</a><a href="#" class="a_btn bg_gay2 "  onclick=" updateRewardInfo()" >拒绝</a></td>
                    </tr>
                </table>
            </div>
        </div>
