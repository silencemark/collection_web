...
function exportexcel(){
	...
	$.ajax({
        type: "POST",
        url: "<%=request.getContextPath() %>/pc/exportLeaveShopList",
...
<div class="page_main">
    ...
    <div class="right_page">
    	<div class="page_name"><span>离店报告单</span><a href="javascript:void(0)" onclick="exportexcel()">导出</a>
    	<c:if test="${powerMap.power4001310 != null}"><a href="<%=request.getContextPath() %>/pc/intoLeaveAdd">新建</a></c:if>
    	</div>
        <div class="page_tab">
            <div class="sel_box">
                <form action="<%=request.getContextPath()%>/pc/getLeaveShopListInfo"
            ...
            <div class="tab_list">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                        	<a href="<%=request.getContextPath() %>/pc/getLeavedetailInfo?inspectid=${item.inspectid}&forwarduserid=${item.forwarduserid}" class="link">查看</a>
                ...
                <c:if test="${fn:length(leavelist) == 0 }">
                	<c:if test="${powerMap.power4001310 != null}">
                		<div class="list_none"><span><i class="yellow">Hello,我是大狮！</i><br>还没有离店报告单，赶紧添加一条吧~</span><b><img src="<%=request.getContextPath() %>/userbackstage/images/index/none_msg.gif" width="293" height="240"></b></div>
                	</c:if>
                	<c:if test="${powerMap.power4001310 == null}">
                		<div class="list_none"><span><i class="yellow">Hi,我是大狮！</i><br>列表空空，还没有离店报告单呢~</span><b><img src="<%=request.getContextPath() %>/userbackstage/images/index/none_msg2.gif" width="293" height="240"></b></div>
                	</c:if>
                </c:if>
            </div>
