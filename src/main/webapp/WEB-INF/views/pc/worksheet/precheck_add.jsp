...
<script type="text/javascript" src="<%=request.getContextPath() %>/pc/worksheet/precheck_add.js"></script>
		<!-- 上传图片需要js -->   
...
<div class="page_main">
    ...
    <div class="right_page">
    	<div class="page_name"><span>新建餐前检查单</span><a href="javascript:void(0)" onclick="window.history.go(-1)" class="back">返回</a></div>
        <div class="page_tab2">            
            <div class="tab_list">
...
<!--                                 </tr>                                                          -->
					...
					<tr>
						...
						<tr class="foot_td">
							<td>&nbsp;</td>
							<td><a href="javascript:void(0)" onclick="addEvaluate()"
