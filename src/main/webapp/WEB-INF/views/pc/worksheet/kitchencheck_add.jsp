...
<script type="text/javascript" src="<%=request.getContextPath() %>/pc/worksheet/kitchencheck_add.js"></script>
...
<div class="page_main">
    ...
    <div class="right_page">
    	<div class="page_name"><span>新建厨房检查单</span><a href="javascript:void(0)" onclick="window.history.go(-1)" class="back">返回</a></div>
        <div class="page_tab2">            
            <div class="tab_list">
...
<!--                                 </tr>                                                          -->
                    ...
                    <tr class="foot_td">
                    	<td>&nbsp;</td>
                        <td><a href="javascript:void(0)" onclick="addEvaluate()" class="a_btn bg_yellow">发送</a><a href="javascript:void(0)" onclick="window.history.go(-1)" class="a_btn bg_gay2">取消</a></td>
                    </tr>
                </table>
            </div>
        </div>
