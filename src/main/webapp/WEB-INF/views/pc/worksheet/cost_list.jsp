...
function exportexcel(){
	...
	$.ajax({
        type: "POST",
        url: "<%=request.getContextPath() %>/pc/exportDishesList",
...
<div class="page_main">
    ...
    <div class="right_page">
    	<div class="page_name"><span>菜品成本单列表</span><a href="javascript:void(0)" onclick="exportexcel()">导出</a>
    	<a href="<%=request.getContextPath() %>/pc/intoCostAdd">新建</a>
    	</div>
        <div class="page_tab">
            <div class="sel_box">
               <form action="<%=request.getContextPath()%>/pc/getcostListInfo"
            ...
            <div class="tab_list">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <c:forEach var="item" items="${costlist}">
                    <tr>
                        <td>${item.dishesname}</td>
                        <td>${item.dishestypename}</td>
                       ...
                       <c:choose>
                        ...
                        <td>
                        	<a href="<%=request.getContextPath() %>/pc/getcostDetailInfo?dishesid=${item.dishesid}&forwarduserid=${item.id}" class="link">查看</a>
                ...
                <c:if test="${fn:length(costlist) == 0 }">
                	<div class="list_none"><span><i class="yellow">Hello,我是大狮！</i><br>还没有菜品成本单，赶紧添加一条吧~</span><b><img src="<%=request.getContextPath() %>/userbackstage/images/index/none_msg.gif" width="293" height="240"></b></div>
                </c:if>
            </div>
