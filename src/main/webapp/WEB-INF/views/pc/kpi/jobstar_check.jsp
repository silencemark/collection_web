...
<script type="text/javascript" src="<%=request.getContextPath() %>/pc/kpi/jobstar_check.js"></script>
...
<div class="page_main">
    ...
    <div class="right_page">
    	<div class="page_name"><span>岗位星值审核</span>
    	<a href="javascript:void(0)" onclick="window.history.go(-1)" class="back">返回</a>
...
<!--                                 <tr> -->
<!--                                 	<td>仪容仪表</td> -->
<!--                                     <td class="t_r"><div class="star_box"><img src="../images/pc_page/start2.png" /><img src="../images/pc_page/start2.png" /><img src="../images/pc_page/start2.png" /><img src="../images/pc_page/start3.png" /><img src="../images/pc_page/start3.png" /></div></td> -->
<!--                                 </tr>                           -->
                                <tr class="none_border">
                                	<td>&nbsp;</td>
                                    <td class="t_r">合计： <i class="yellow" id="sumstar">21</i> 星</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr class="none_border">
                        ...
                        <td><textarea class="text_area" placeholder="请输入审批人意见，最多允许输入800字符" maxlength="800" id="adivce"></textarea></td>
                    </tr>
                    <tr>
                    	<td>&nbsp;</td>
                        <td><a href="javascript:void(0)" class="a_btn bg_yellow" onclick="tongyi(1)">同意</a><a href="javascript:void(0)" class="a_btn bg_gay2" onclick="tongyi(2)">拒绝</a></td>
                    </tr>
                </table>
            </div>
        </div>
