...
<script type="text/javascript" src="<%=request.getContextPath() %>/pc/kpi/jobstar_add.js"></script>
...
<div class="page_main">
    ...
    <div class="right_page">
    	<div class="page_name"><span>岗位星值自评</span><a style="cursor: pointer;" onclick="window.history.go(-1)" class="back">返回</a></div>
        <div class="page_tab2">            
            <div class="tab_list">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="none_border">
                    <tr>
                    	<td class="l_name">所属区域</td>
                        <td><select class="text" id="organize_option"></td>
                    </tr>
                    <tr class="last_td">
                    	<td class="l_name">岗位名称</td>
                        <td><select class="text" id="store_ul"></td>
                    </tr>
...
<!--                                     <td class="t_r"> -->
<!--                                     	<div class="star_box"> -->
<!--                                     		<a class="a_star"><img src="/userbackstage/images/pc_page/start2.png" /></a> -->
<!--                                     		<a class="a_star"><img src="../images/pc_page/start2.png" /></a> -->
<!--                                     		<a class="a_star"><img src="../images/pc_page/start2.png" /></a> -->
<!--                                     		<a class="a_star"><img src="../images/pc_page/start3.png" /></a> -->
<!--                                     		<a class="a_star"><img src="../images/pc_page/start3.png" /></a> -->
<!--                                     	</div> -->
<!--                                     </td> -->
<!--                                 </tr> -->
                    ...
                    <tr class="first_td">
                        ...
                        <td class="img_td"><div class="img f"><img src="../userbackstage/images/pc_page/user_img2.png" width="30" height="30" id="examineheadimage"/></div><i class="i_name" id="examinename"></i><a href="javascript:void(0)" onclick="openOrCloseExamineDiv()" class="add_user">添加</a></td>
                    </tr>
                    <tr>
                    	<td class="l_name">申请人</td>
                        <td class="img_td"><div class="img f"><img id="shenqingren_img" src="${user.headimage }" width="30" height="30" /></div><i class="i_name" id="shenqingren">${user.realname }</i></td>
                    </tr>
                    <tr>
                    ...
                    <tr class="foot_td">
                    	<td>&nbsp;</td>
                        <td><a href="javascript:void(0)" class="a_btn bg_yellow" onclick="addEvaluate()">发送</a><a href="javascript:void(0)" onclick="window.history.go(-1)" class="a_btn bg_gay2">取消</a></td>
                    </tr>
                </table>
            </div>
        </div>
