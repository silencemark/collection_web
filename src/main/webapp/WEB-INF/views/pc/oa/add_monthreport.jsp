...
<jsp:include page="left.jsp"></jsp:include>
    <div class="right_page">
    	<div class="page_name"><span>新建月报</span><a href="<%=request.getContextPath() %>/pc/getPcOaLogList" class="back">返回</a></div>
        <div class="page_tab2">      
        	<div class="rsgj_nav">
                <ul>
                    ...
                    <li class="active"><a href="<%=request.getContextPath() %>/pc/getPcOaLogAddMonth">月报</a></li>
                </ul>
            </div>                 
            <div class="tab_list">
                   ...
                   <tr>
                    	<td class="l_name">时间</td>
                          <td>
                        	...
                        	<span>-</span> -->
                        	<input  class="text" placeholder="请选择月份" onclick="WdatePicker({dateFmt:'yyyy-MM'})" name="endtime" value="${enddate.substring(0,7)}"   id="endtime"  class="text_time" type="text"  readonly="readonly"  style="width: 135px;"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    	<td class="l_name2">下月工作计划</td>
                        <td>
                        	<textarea class="text_area" placeholder="请输入下个月工作计划，最多允许输入800字符" maxlength="800" id="nextplan"></textarea>
                        </td>
                    </tr>
                    <tr>
