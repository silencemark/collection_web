...
<jsp:include page="left.jsp"></jsp:include>
    <div class="right_page">
    	<div class="page_name"><span>请假详情</span><a href="<%=request.getContextPath() %>/pc/getPcOaRestList" class="back">返回</a>
