...
<jsp:include page="left.jsp"></jsp:include>
    <div class="right_page">
    	<div class="page_name"><span>新建通用审批</span><a href="<%=request.getContextPath() %>/pc/getPcOaApprovaList" class="back">返回</a></div>
        <div class="page_tab2">            
            <div class="tab_list">
<!--              <input type="file" name="myfiles" style="display: none" id="fileName" T="file_headimg" onchange="ajaxFileUpload('img')"/>       	 -->
			 <input type="file" style="display: none" name="myfiles" id="fileName" multiple/>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="none_border" style="font-size:12px;">
                    <tr>
                    	<td class="l_name">申请内容</td>
                        <td><textarea class="text_area" placeholder="请输入申请内容，最多允许输入800字符" id="content" maxlength="800"></textarea></td>
                    </tr>
                    <tr class="last_td">
                    	<td class="l_name2">审批原因</td>
                        <td>
                        	<textarea class="text_area" placeholder="请输入详情内容，最多允许输入800字符" id="details" maxlength="800"></textarea>
                            <div class="clear"></div>
                    ...
                    <tr class="foot_td">
                    	<td>&nbsp;</td>
                        <td><a href="#" class="a_btn bg_yellow" onclick="addApproval()">发送</a><a href="<%=request.getContextPath()%>/pc/getPcOaApprovaList" class="a_btn bg_gay2">取消</a></td>
                    </tr>
                </table>
            </div>
        </div>
