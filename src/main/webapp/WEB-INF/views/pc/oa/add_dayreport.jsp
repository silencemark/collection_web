...
function checkAdd(){
	...
	param.notcompletedwork = $('#notcompletedwork').val();
...
<jsp:include page="left.jsp"></jsp:include>
    <div class="right_page">
    	<div class="page_name"><span>新建日报</span><a href="<%=request.getContextPath() %>/pc/getPcOaLogList" class="back">返回</a></div>
        <div class="page_tab2">      
        	<div class="rsgj_nav">
                <ul>
                    <li class="active"><a href="<%=request.getContextPath() %>/pc/getPcOaLogAddDay">日报</a></li>
                   <li><a href="<%=request.getContextPath() %>/pc/getPcOaLogAddWeek">周报</a></li>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="none_border" style="font-size:12px;">
                   <tr>
                    	<td class="l_name">时间</td>
                          <td>
                        	<input  class="text" style="width: 100px;" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="endtime" value="${createdate}"   id="time"  class="text_time" type="text"  readonly="readonly"  style="width: 135px;"/>
                        </td>
                    </tr>
                    <tr>
                    	<td class="l_name2">完成工作</td>
                        <td>
                        	<textarea class="text_area" placeholder="请输入完成工作的内容，最多允许输入800字符" id="completedwork" maxlength="800"></textarea>
                        </td>
                    </tr>
                    <tr>
                    	<td class="l_name2">未完成工作</td>
                        <td>
                        	<textarea class="text_area" placeholder="请输入未完成工作的内容，最多允许输入800字符" id="notcompletedwork" maxlength="800"></textarea>
                        </td>
                    </tr>
                    <tr>
                    	<td class="l_name2">需协调工作</td>
                        <td>
                        	<textarea class="text_area" placeholder="请输入需协调工作的内容，最多允许输入800字符" id="needhelp" maxlength="800"></textarea>
                        </td>
                    </tr>
           			 <tr>
                    ...
                    <tr class="last_td">
                        ...
                        <td>
                        	<textarea class="text_area" placeholder="请输入详情内容，最多允许输入800字符" id="remark" maxlength="800"></textarea>
                            <div class="clear"></div>
