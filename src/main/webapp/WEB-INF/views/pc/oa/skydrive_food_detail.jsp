...
function onloadDate(){
	$.ajax({
 		type:'post',
 		url:'/pc/getCompanyCloudInfoDetail',
 		data:param,
...
<jsp:include page="left.jsp"></jsp:include>
    <div class="right_page">
    	<div class="page_name"><span>文件详情</span><a href="<%=request.getContextPath() %>/pc/getPcOaSkydriveFoodList?moduleid=${map.moduleid}" class="back">返回</a></div>
        <div class="page_tab2">
