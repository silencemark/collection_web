...
function examineInfo(result){
	var param = new Object();
	param.currencyexamineid ='${map.currencyexamineid}';
	param.userid = '${userInfo.userid}';
	param.opinion = $('#opinion').val();
	param.result = result;
	
	$.ajax({
		url:"/pc/updateCurrencyExamineInfo",
		type:"post",
		data:param,
		success:function(resultMap){
			if(resultMap.status == 0 || resultMap.status == '0'){
				changeIsread(examine_createid,'${map.currencyexamineid}');
				var title=$("#examinename").text()+"审批了您的通用审批申请,请及时查看";
				var url="/oa/approval_detail.html?currencyexamineid=${map.currencyexamineid}&userid="+examine_createid;
				...
				swal({
					...
					location.href='<%=request.getContextPath() %>/pc/getPcOaApprovaList';
				});
			}
		}
	});
...
<jsp:include page="left.jsp"></jsp:include>
    <div class="right_page">
    	<div class="page_name"><span>通用审批详情</span><a href="<%=request.getContextPath() %>/pc/getPcOaApprovaList" class="back">返回</a>
...
<!--     	<a href="#" onclick="showForwardDiv()">转发</a> -->
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:12px;">
                    ...
                    <tr>
                     ...
                     <tr class="none_border">
                    	...
                    	<td><textarea class="text_area" placeholder="请输入审批意见，最多允许输入800字符" id="opinion" maxlength="800"></textarea></td>
                    </tr>
                   <tr class="none_border">
                    	<td>&nbsp;</td>
        ...
        <div class="comment">
       	<div class="name">共有<i class="yellow" id="num"></i>条评论</div>
            <div class="text_box" >
<!--             	<b><textarea placeholder="请输入评论内容，最多允许输入800字符" maxlength="200" id="content_text1"></textarea></b> -->
