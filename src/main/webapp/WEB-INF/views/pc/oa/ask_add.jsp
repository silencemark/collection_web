...
<jsp:include page="left.jsp"></jsp:include>
    <div class="right_page">
    	<div class="page_name"><span>新建请示</span><a href="<%=request.getContextPath() %>/pc/getPcOaAskList" class="back">返回</a></div>
        <div class="page_tab2">            
            <div class="tab_list">
<!--              <input type="file" name="myfiles" style="display: none" id="fileName" T="file_headimg" onchange="ajaxFileUpload('img')"/>       	 -->
			 <input type="file" style="display: none" name="myfiles" id="fileName" multiple/>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="none_border" style="font-size:12px;">
                    <tr>
                    	<td class="l_name">事由</td>
                        <td><textarea class="text_area" placeholder="请输入事由，最多允许输入800字符" maxlength="800" id="reason"></textarea></td>
                    </tr>
                     <tr>
                    ...
                    <tr class="last_td">
                        ...
                        <td>
                        	<textarea class="text_area" placeholder="请输入具体内容，最多允许输入800字符" maxlength="800"id="content"></textarea>
                            <div class="clear"></div>
                    ...
                    <tr class="foot_td">
                    	<td>&nbsp;</td>
                        <td><a href="javascript:void(0)" class="a_btn bg_yellow" onclick="checkAdd()">发送</a><a href="<%=request.getContextPath()%>/pc/getPcOaAskList" class="a_btn bg_gay2">取消</a></td>
                    </tr>
                </table>
            </div>
        </div>
