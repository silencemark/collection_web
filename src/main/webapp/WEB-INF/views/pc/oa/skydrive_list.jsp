 					...
 					for(var i= 0;i<data.datalist.length;i++){
 						temp+="<tr>"+
	 	                        ...
	 	                        if(data.datalist[i].filetype==2){
	 	                        	temp+="<td><a href=\"<%=request.getContextPath() %>/pc/getPcOaSkydriveList?parentid="+data.datalist[i].fileid+"&moduleid="+moduleid+"\" class=\"link\">查看</a></td></tr>";
	 	                        }else if(data.datalist[i].filetype==1){
	 	                        	temp+="<td><a href=\"<%=request.getContextPath() %>/pc/getPcOaSkydriveDetail?fileid="+data.datalist[i].fileid+"&moduleid="+moduleid+"\" class=\"link\">查看</a>";
	 	                        	//"<a href=\"#\" class=\"yellow\" onclick=\"downloadfile('"+data.datalist[i].fileurl+"')\">下载</a></td></tr>";
	 	                        }
...
var nodata = '<div class="list_none"><span><i class="yellow">Hello,我是大狮！</i><br>列表空空，网盘还没有文件呢</span><b><img src="/userbackstage/images/index/none_msg.gif" width="293" height="240"></b></div>';
function onloadDate(){
	$.ajax({
 		type:'post',
 		url:'/pc/getCompanyCloudList',
...
<jsp:include page="left.jsp"></jsp:include>
    <div class="right_page">
    	<div class="page_name"><span>企业网盘列表</span><a href="<%=request.getContextPath() %>/pc/getPcOaSkydrive" class="back">返回</a></div>
        <div class="page_tab">
            <div class="sel_box">
