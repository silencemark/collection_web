...
function exportexcel(){
	$.ajax({
        type: "POST",
        url: "<%=request.getContextPath() %>/userbackstage/exportLogList",
...
$(document).ready(function(){
	$('#nav_log').attr('class','active');$('#nav_log').parent().parent().show();
})
</script>
</head>
<body>
...
<div class="main_page">
	...
	<div class="page_nav"><p><a href="<%=request.getContextPath() %>/userbackstage/index">首页</a><i>/</i><a href="#">企业管理</a><i>/</i><span>管理日志</span></p></div>  
    <div class="page_tab m_top">
        <div class="tab_name"><span class="gray1">管理日志</span><a href="javascript:void(0)" onclick="exportexcel();">导出</a></div>
         <div class="sel_box">
         	<form action="<%=request.getContextPath() %>/userbackstage/getLogList" method="post" id="searchform">
