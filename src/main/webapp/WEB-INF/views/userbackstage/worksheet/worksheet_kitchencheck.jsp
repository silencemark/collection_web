...
<script type="text/javascript" src="<%=request.getContextPath() %>/userbackstage/worksheet/worksheet_kitchencheck.js"></script>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('#nav_check${map.type}').attr('class','active');$('#nav_check${map.type}').parent().parent().show();
		
		setTimeout("chooseorg()",300);
		
	})
	
	function chooseorg(){
		$("#li_${userinfo.organizeid}").parents("ul").show().prev().attr("class","bg_show");
		$('#companyname').click();
		$("#li_${userinfo.organizeid}").find("span").get(0).click();
...
<div class="main_page">
	...
	<div class="page_nav"><p><a href="#">首页</a><i>/</i><a href="#">工作表单</a><i>/</i><span>${map.workname }</span></p></div>  
    <input type="hidden" id="type" value="${map.type }"/>
    <input type="hidden" id="managerole" value="${map.managerole }"/>
    <input type="hidden" id="typeid" value="${map.typeid }"/>
    <input type="hidden" id="companyid" value="${user.companyid }"/>
    <input type="hidden" id="userid" value="${user.userid }"/>
    
    <div class="page_tab m_top">
        <div class="tab_name">
        	<span class="gray1">${map.workname }</span>
        	<a href="javascript:void(0)" id="addTemplate_insert" style="display: none;" onclick="queryTemplateProject_div('first')">新建</a>
        	<a id="editorgangweimuban" style="display: none;" href="javascript:void(0)" onclick="updateTemplateCloseOrOpenDiv('first');organizeTemplateList();">编辑模板</a>
        </div>
        <div class="worksheet">
            ...
            <div class="r_list" style="width:69%; min-height:460px;">
            	<div class="tab_list">
                	<table border="0" cellpadding="0" cellspacing="0" width="100%" id="inspecttemplate_list">
<!--                      	<tr> -->
<!--                         	<td width="76%">徐家汇店-二楼大厅检查</td> -->
...
<div class="tc_worksheet" style="display:none;max-height:550px; overflow:auto; width:750px;" id="addTemplate">
	...
	<div class="tc_title"><span>${map.workname }模板</span><a href="javascript:void(0)" onclick="queryTemplateProject_div()">×</a></div>
    ...
    <div class="tab_list">
        ...
        <div>
       	...
       	<table border="0" cellpadding="0" cellspacing="0" width="100%">   
            <tr>
            	<td><span class="gray2">区域名称</span> <input type="text" class="text" placeholder="请输入区域名称" id="add_templateName" maxlength="8"/></td>
                <td></td>
            </tr>
            <tr class="head_td">
            	<td>发布范围</td>
    ...
    <div class="tc_btnbox"><a href="javascript:void(0)" onclick="queryTemplateProject_div();" class="bg_gay2">取消</a>
    	<a href="javascript:void(0)" onclick="addProjectAndTemplate()" id="addTemplate_submit" class="bg_yellow">确定</a>
    	<a href="javascript:void(0)" onclick="updateReleaseRange()" style="display: none;" id="updateTemplate_submit" class="bg_yellow">确定</a></div>
</div>
...
<div class="tc_selrange" style="display:none" id="tc_selrange">
	<div class="tc_title"><span>发布范围</span><a href="javascript:void(0);" onclick="chagneRange();queryTemplateProject_div();">×</a></div>
    <div class="range">
...
<div class="tc_worksheet" style="display:none; max-height:600px; overflow:auto; width:750px;" id="updateTemplate">
    ...
    <div class="tab_list">
    	<table border="0" cellpadding="0" cellspacing="0" width="100%">   
            <tr>
            	<td><span class="gray2">模板名称</span> <input type="text" class="text" placeholder="请输入模板名称" maxlength="8" id="update_templateName"/></td>
                <td></td>
            </tr>
        </table>
    	<table border="0" cellpadding="0" cellspacing="0" width="100%">
