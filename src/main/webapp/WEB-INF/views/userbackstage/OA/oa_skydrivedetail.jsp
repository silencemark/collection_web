...
<jsp:include page="../top.jsp" flush="true"></jsp:include>
	...
	<div class="page_nav"><p><a href="#">首页</a><i>/</i><a href="#">OA办公</a><i>/</i><a href="/userbackstage/getCompanyCloudModuleList">企业云盘</a><i>/</i><a href="/userbackstage/intoCompanyCloudFilePage?moduleid=${map.moduleid}">企业云盘文件</a><i>/</i><span>企业云盘文件详情</span></p></div>  
    ...
    <form id="deleteform" action="<%=request.getContextPath() %>/userbackstage/deleteCompanyCloudFileInfo" method="post">
    	...
    	<div class="tab_name"><span id="title"></span><a href="javascript:void(0)" onclick="deleteCloudFile()">删除</a><a href="/userbackstage/intoUpdateCloudFile?fileid=${map.fileid }&moduleid=${map.moduleid}">修改</a></div>
