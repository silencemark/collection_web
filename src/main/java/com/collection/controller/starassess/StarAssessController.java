package com.collection.controller.starassess;
...
public class StarAssessController {
	private transient static Log log = LogFactory.getLog(StarAssessController.class);
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="/getEvaluateAllNotIsRead")
	public Map<String,Object> getEvaluateAllNotIsRead(@RequestParam Map<String,Object> map , HttpServletRequest request , HttpServletResponse response){
		response.setHeader("Access-Control-Allow-Origin", "*");
		...
		try {
			...
			//查询已处理的未读总数
			map.put("status", 1);
			int count=this.starAssessService.getEvaluateListTimeCount(map);
			
			resultMap.put("status", 0);
			resultMap.put("evalnum", num);
			resultMap.put("evaltimenum", count);
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="/getExamineEvaluateList")
	public Map<String,Object> getExamineEvaluateList(@RequestParam Map<String, Object> map, Model model, HttpServletRequest request,
			HttpServletResponse response){
		response.setHeader("Access-Control-Allow-Origin", "*");
		PageScroll page = new PageScroll();
		int num=this.starAssessService.getEvaluateListTimeCount(map);	
		page.setTotalRecords(num);
		page.initPage(map);
		List<Map<String, Object>> list=this.starAssessService.getEvaluateListTime(map);
		Map<String, Object> data=new HashMap<String, Object>();
		data.put("num", num);
		data.put("data", list);
		data.put("status",0);
	...
	public Map<String, Object> examineEvaluate(@RequestParam Map<String, Object> map, Model model, HttpServletRequest request,
		...
		try {
			...
			for(Map<String,Object> mm : starlist){
				this.starAssessService.updateEvaluateStarInfo(mm);
			}
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
	 ...
	 * @return
	 */
	@RequestMapping("/getAllEvaluateList")
	@ResponseBody
	public Map<String, Object> getAllEvaluateList(@RequestParam Map<String, Object> map, Model model, HttpServletRequest request,
			HttpServletResponse response) {
		response.setHeader("Access-Control-Allow-Origin", "*");
		PageScroll page = new PageScroll();
		int num=this.starAssessService.getEvaluateListNum(map);		
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="/getOverallvaluateAllNotIsRead")
	public Map<String,Object> getOverallvaluateAllNotIsRead(@RequestParam Map<String,Object> map , HttpServletRequest request , HttpServletResponse response){
		response.setHeader("Access-Control-Allow-Origin", "*");
		Map<String,Object> resultMap = new HashMap<String,Object>();
		try {
			//查询未处理中的未读数量
			...
			//查询已处理中的未读数量
			map.put("status", 1);
			int num = this.starAssessService.getOverallvaluateListTimeCount(map);
			
			resultMap.put("status", 0);
			resultMap.put("overnum", count);
			resultMap.put("overtimenum", num);
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
			resultMap.put("status", 1);
	...
	public Map<String,Object> getOverallvaluateList(@RequestParam Map<String,Object> map , 
		...
		try {
			...
			data.put("num", count);
			data.put("overallvaluatelist", list);
			data.put("status",0);
			data.put("page",page);
		} catch (Exception e) {
			// TODO: handle exception
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="/getExamineOverallvaluateList")
	public Map<String,Object> getExamineOverallvaluateList(@RequestParam Map<String,Object> map , 
			HttpServletResponse response){
		response.setHeader("Access-Control-Allow-Origin", "*");
		...
		try {
			PageScroll page = new PageScroll();
			int count = this.starAssessService.getOverallvaluateListTimeCount(map);
			page.setTotalRecords(count);
			page.initPage(map);
			List<Map<String,Object>> list = this.starAssessService.getOverallvaluateListTime(map);
	...
	public Map<String, Object> examineOverallvaluate(@RequestParam Map<String, Object> map, Model model, HttpServletRequest request,
		...
		try {
			...
			List<Map<String, Object>> starlist=(List<Map<String, Object>>)json.get("starlist");
			for(Map<String,Object> mm : starlist){
				this.starAssessService.updateOverAllaluateStarInfo(mm);
			}
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="/getAllOverallvaluateList")
	public Map<String,Object> getAllOverallvaluateList(@RequestParam Map<String,Object> map , 
			HttpServletResponse response){
		response.setHeader("Access-Control-Allow-Origin", "*");
		Map<String, Object> data =new HashMap<String, Object>();
