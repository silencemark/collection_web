...
public class PCIndexController extends BaseController{
	...
	private transient static Log log = LogFactory.getLog(PCIndexController.class);
	...
	public Map<String, Object> getcity(HttpServletRequest request,@RequestParam Map<String, Object> map, Model model
		...
		System.out.println("lat=".concat(map.get("lat").toString()).concat(";lon=").concat(map.get("lon").toString()));
		log.info("lat=".concat(map.get("lat").toString()).concat(";lon=").concat(map.get("lon").toString()));
		response.setHeader("Access-Control-Allow-Origin", "*");
		...
		if(map.get("lat")!=null && !map.get("lat").equals("") && map.get("lng") !=null && !map.get("lng").equals("")){
			...
			RedisUtil.setMap("cityInfo"+map.get("userid"), cityInfo, 1);
			...
			if(cityInfo!= null && cityInfo.size()>0){
				System.out.println("start weathermap..........");
				log.info("start weathermap..........");
		...
		System.out.println("getCity........OVER............");
		log.info("getCity........OVER............");
		return cityInfo;
	}
	...
	public Map<String, Object> getWeather(HttpServletRequest request,@RequestParam Map<String, Object> map, Model model
		...
		Map<String, Object> cityInfo=RedisUtil.getMap("cityInfo"+map.get("userid"));
		if(cityInfo!= null && cityInfo.size()>0){
			cityInfo=this.indexService.getCityId(cityInfo);
			if(cityInfo!= null && cityInfo.size()>0){
				System.out.println("getWeather........cityname="+cityInfo.get("cityname"));
				log.info("getWeather........cityname="+cityInfo.get("cityname"));
				heweather hewe=new heweather();
				Map<String, Object> weathermap=new HashMap<String, Object>();
				String weathername=hewe.getweathername(cityInfo.get("id")+"");
				String temperature=hewe.getTemperature(cityInfo.get("id")+"");
