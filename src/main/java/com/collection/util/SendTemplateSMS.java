...
public class SendTemplateSMS {
	//帐号id
	private static String ACCOUNT_SID="8aaf0708732220a601735ff074111aa7";
	//帐号令牌
	private static String AUTH_TOKEN="99f0931492c5486e96b32449cf8c669c";
	//应用id
	private static String APPID="8aaf0708732220a601735ff075091aae";
	...
	/**
	 * 注册/改密码发送验证码
	 * 尊敬的用户，您的本次操作验证码为：{1}，请在{2}分钟内完成操作，如非本人操作请忽略本条短信。
	 * @param args
	 */
	...
	/**
	 * 注册/改密码发送验证码
	 * 尊敬的用户，欢迎注册享GO，您的本次操作验证码为：{1}，请在{2}分钟内完成操作，如非本人操作请忽略本条短信。
	 * @param phone 接受者手机号码
	 * @param vc 验证码
	 * @param mintue 有效时间
	 * @return
